  ...
  useEffect(() => {
    ...
    let json = [
      ...
      },
      {
        ...
        "Something that happens while you travel":
          "The road is blocked by bandits",
      ...
      },
      {
        ...
        "Something that happens while you travel":
          "a badger fell into a deep hole",
      ...
      },
      {
        ...
        Problem:
          "A rhino keeps sledding through the town and stealing the bread",
      ...
      },
      {
        ...
        Problem:
          "Jellyfish want hugs. You have to figure out how to not get stung",
        ...
        <div className="Story-Container">
          <div className="Story-Content-Container">
            ...
            <div className="Story-Content">
              <span id="js-name"></span>
              the
              <span id="js-description"></span>
