...
describe("Helpers", () => {
  ...
  describe("checkClueHasBeenAnswered", () => {
    ...
    it("should return true when the clue has been answered", () => {
      expect(checkClueHasBeenAnswered(gridFixture, answeredEntryFixture)).toBe(
        true
      );
    });
    ...
    it("should return true when a clue that contains numbers has been answered", () => {
      expect(
        checkClueHasBeenAnswered(gridFixture, answeredEntryWithNumbersFixture)
      ).toBe(true);
    });
  ...
  describe("getClearableCellsForEntry", () => {
    ...
    const gridFixture = [
      ["R", "I", "V", "E", "R", "", "C", "", "L", "U", "S", "T", "R", "E"].map(
        stubCellWithValue
      ),
      ["", "", "", "", "", "", "L", "", "I", "", "", "", "", ""].map(
        stubCellWithValue
      ),
      ["S", "A", "N", "T", "A", "", "A", "", "G", "I", "S", "T", "", ""].map(
        stubCellWithValue
      ),
      ["", "", "", "", "", "", "U", "", "H", "", "O", "", "", ""].map(
        stubCellWithValue
